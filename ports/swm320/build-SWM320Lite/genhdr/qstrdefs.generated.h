...
QDEF(MP_QSTR_ADC_CH0, (const byte*)"\x67\x07" "ADC_CH0")
QDEF(MP_QSTR_ADC_CH1, (const byte*)"\x66\x07" "ADC_CH1")
QDEF(MP_QSTR_ADC_CH2, (const byte*)"\x65\x07" "ADC_CH2")
QDEF(MP_QSTR_ADC_CH3, (const byte*)"\x64\x07" "ADC_CH3")
QDEF(MP_QSTR_ADC_CH4, (const byte*)"\x63\x07" "ADC_CH4")
QDEF(MP_QSTR_ADC_CH5, (const byte*)"\x62\x07" "ADC_CH5")
QDEF(MP_QSTR_ADC_CH6, (const byte*)"\x61\x07" "ADC_CH6")
QDEF(MP_QSTR_ADC_CH7, (const byte*)"\x60\x07" "ADC_CH7")
QDEF(MP_QSTR_BOTH_EDGE, (const byte*)"\xc8\x09" "BOTH_EDGE")
QDEF(MP_QSTR_BytesIO, (const byte*)"\x1a\x07" "BytesIO")
QDEF(MP_QSTR_DATA_8BIT, (const byte*)"\xed\x09" "DATA_8BIT")
QDEF(MP_QSTR_DATA_9BIT, (const byte*)"\x0c\x09" "DATA_9BIT")
QDEF(MP_QSTR_DEBUG, (const byte*)"\x34\x05" "DEBUG")
QDEF(MP_QSTR_EDGE_FIRST, (const byte*)"\x63\x0a" "EDGE_FIRST")
QDEF(MP_QSTR_EDGE_SECOND, (const byte*)"\xc9\x0b" "EDGE_SECOND")
...
QDEF(MP_QSTR_LEVEL_HIGH, (const byte*)"\x22\x0a" "LEVEL_HIGH")
QDEF(MP_QSTR_LEVEL_LOW, (const byte*)"\x78\x09" "LEVEL_LOW")
QDEF(MP_QSTR_LOW_LEVEL, (const byte*)"\x78\x09" "LOW_LEVEL")
QDEF(MP_QSTR_MODE_COMPL, (const byte*)"\xa4\x0a" "MODE_COMPL")
QDEF(MP_QSTR_MODE_COUNTER, (const byte*)"\x0d\x0c" "MODE_COUNTER")
QDEF(MP_QSTR_MODE_INDEP, (const byte*)"\xaf\x0a" "MODE_INDEP")
...
QDEF(MP_QSTR_STOP_1BIT, (const byte*)"\x8c\x09" "STOP_1BIT")
QDEF(MP_QSTR_STOP_2BIT, (const byte*)"\xaf\x09" "STOP_2BIT")
...
QDEF(MP_QSTR_chn_select, (const byte*)"\x17\x0a" "chn_select")
QDEF(MP_QSTR_chns, (const byte*)"\xb3\x04" "chns")
...
QDEF(MP_QSTR_pinA, (const byte*)"\x73\x04" "pinA")
QDEF(MP_QSTR_pinB, (const byte*)"\x70\x04" "pinB")
...
QDEF(MP_QSTR_ssel, (const byte*)"\x8c\x04" "ssel")
